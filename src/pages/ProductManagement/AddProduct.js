...
const AddProduct = () => {
  ...
  const handleCreateBrand = async () => {
    ...
    try {
      ...
      setNewProduct(prev => ({ ...prev, brand: trimmed }));
      setNewBrandName("");
          ...
          <Card title="Product Images" icon={<ImageIcon className="w-5 h-5 text-pink-600" />}>
            ...
            {imageSourceTab === "file" ? (
              ...
              <div
                ...
                className={`mt-4 border-2 border-dashed rounded-xl p-8 text-center cursor-pointer transition-all duration-300 ${
                  dragActive
              ...
              <div className="bg-gray-50 border border-gray-150 rounded-xl p-6 mt-4 space-y-4">
